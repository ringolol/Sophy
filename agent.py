import os
from smolagents import FinalAnswerPromptTemplate, ManagedAgentPromptTemplate, Panel, PlanningPromptTemplate, PromptTemplates, ToolCallingAgent, LogLevel
...
if __name__ == "__main__":
    ...
    console.print("Type /quit to exit, /resume to switch sessions, /new to create a new session.\n")
