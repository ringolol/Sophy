...
Sophy is an AI-powered coding agent built on top of the smolagents library. It implements a tool-call  
loop where an agent solves tasks passed by users through interactive CLI.
